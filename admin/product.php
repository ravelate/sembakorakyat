  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <a href="../admin/createbarang.php" class="btn btn-success pull-right">Tambah</a>
        <div class="row mb">
          <!-- page start-->
          <div class="content-panel">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                    ...
                    <tr>
                      ...
                      <th class="hidden-phone">Sisa Produk</th>
                      <th class="hidden-phone">Produk telah Terjual</th>
                      <th class="hidden-phone">Actions</th>
                      
                    </tr>
                  </thead>
                  <tbody>
                    <?php $product = queryadmin("SELECT * FROM barang");
                    foreach ($product as $us) :
                    ?>
                      <tr class="gradeA">
                        <td><?= $us['id'] ?></td>
                        <td><?= $us['nama_barang'] ?></td>
                        <td class="hidden-phone"><?= $us['harga'] ?></td>
                        <td class="hidden-phone"><img src="<?= $us['gambar'] ?>" alt="" width="70px" height="70px"></td>
                        <td class="center hidden-phone"><?= $us['kategori'] ?></td>
                        <td class="hidden-phone"><?= $us['jumlah'] ?></td>
                        <td class="hidden-phone"><?= $us['jumlah_terjual'] ?></td>
                        <td class="center hidden-phone">
                           <a href="../admin/editbarang.php?id=<?= $us['id'] ?>" class="btn btn-warning">Edit</a>
