        ...
        <div class="row mb">
          ...
          <div class="content-panel">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                  ...
                  <tbody>
                    <?php $user = queryadmin("SELECT * FROM users");
                    foreach ($user as $us) :
                    ?>
                      <tr class="gradeA">
                        <td><?= $us['id'] ?></td>
                        <td><?= $us['nama'] ?></td>
                        <td class="hidden-phone"><?= $us['email'] ?></td>
                        <td class="hidden-phone"><?= $us['no_telepon'] ?></td>
                        <td class="center hidden-phone"><?= $us['alamat'] ?></td>
                        <td class="center hidden-phone">
                           <a href="../admin/edituser.php?id=<?= $us['id'] ?>" class="btn btn-warning">Edit</a>
