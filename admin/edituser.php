  ...
  <div class="container">
    <div class="testbox">
        <form action="" method="POST" enctype="multipart/from-data">
          ...
          <br>
          <?php $datauser = queryadmin("SELECT * FROM users WHERE id = {$_GET['id']}");
          ...
          <div class="form-group">
            ...
            <input class="form-control round-form" id="disabledInput" name="nama" type="text" placeholder="<?= $user['nama'] ?>" value="<?= $user['nama']?>">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="user_id">No Telepon</label>
            <input class="form-control round-form" id="disabledInput" name="no_telepon" type="text" placeholder="<?= $user['no_telepon'] ?>" value="<?= $user['no_telepon']?>">
          </div>
          <div class="form-group">
            <label for="user_id">Alamat</label>
            <input class="form-control round-form" id="disabledInput" name="alamat" type="text" placeholder="<?= $user['alamat'] ?>" value="<?= $user['alamat']?>">
          </div>
          <div class="form-group">
