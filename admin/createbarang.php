    ...
    <div class="testbox">
        <form action="" method="POST" enctype="multipart/from-data">
          ...
          <div class="form-group">
            ...
            <input class="form-control round-form" id="disabledInput" name="nama_barang" type="text">
          </div>
          <div class="form-group">
            <label for="user_id">Harga</label>
            <input class="form-control round-form" id="disabledInput" name="harga" type="text">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input class="form-control round-form" id="disabledInput" name="kategori" type="text">
          </div>
          <div class="form-group">
            <label for="user_id">Jumlah Produk</label>
            <input class="form-control round-form" id="disabledInput" name="jumlah" type="text">
          </div>
          <div class="form-group">
            <label for="user_id">Jumlah Terjual</label>
            <input class="form-control round-form" id="disabledInput" name="jumlah_terjual" type="text">
          </div>
          <div class="form-group">
            <input type="submit" class="btn btn-primary btn-lg btn-block" name="create" value="tambah">
          </div>
        </form>
